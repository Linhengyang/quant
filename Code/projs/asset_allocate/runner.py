...
def mvopt():
    ...
    return run(inputs, benchmarkStrat, meanvarOptStrat)
...
def riskmanage():
    ...
    return run(inputs, benchmarkStrat, riskMngStrat)
...
def fixedcomb():
    ...
    return run(inputs, benchmarkStrat, FxdCombStrat)